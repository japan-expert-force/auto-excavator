scoreboard objectives add tick dummy [{"text":"Tick"}]
...
scoreboard players set auto-excavator-var 4 4
scoreboard players set auto-excavator-var 5 5
scoreboard players set auto-excavator-var 6 6
scoreboard players set auto-excavator-var 7 7
scoreboard players set auto-excavator-var 8 8
scoreboard players set auto-excavator-var 9 9
scoreboard players set auto-excavator-var 10 10
tellraw @a ["Auto Excavator was loaded!"]
